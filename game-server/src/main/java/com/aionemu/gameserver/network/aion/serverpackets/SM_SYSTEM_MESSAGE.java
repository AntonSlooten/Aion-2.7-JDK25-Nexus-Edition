...
public class SM_SYSTEM_MESSAGE extends AionServerPacket {
	 ...
	 * %1 of %0 uses %3 in %2.
	 */
	public static SM_SYSTEM_MESSAGE STR_SKILL_ABYSS_SKILL_IS_FIRED(String value1, String value0, String value3,
			String value2) {
	...
	/**
	 * You can see the Energy Drink Can that Shulacks often drink. Certainly there
