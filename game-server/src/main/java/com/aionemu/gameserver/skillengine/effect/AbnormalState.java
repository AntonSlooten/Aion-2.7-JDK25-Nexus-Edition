...
public enum AbnormalState {
	BUFF(0), POISON(1), BLEED(2), PARALYZE(4, 2), SLEEP(8), ROOT(16), // ?? cannot move ?
	BLIND(32), UNKNOWN(64), DISEASE(128), SILENCE(256), FEAR(512), // Fear I
	CURSE(1024), CHAOS(2056), STUN(4096, 2), PETRIFICATION(8192), STUMBLE(16384, 1), STAGGER(32768, 1),
	OPENAERIAL(65536, 1), SNARE(131072), SLOW(262144), SPIN(524288, 1), BIND(1048576), DEFORM(2097152), // (Curse of
																										// Roots I, Fear
																										// I)
