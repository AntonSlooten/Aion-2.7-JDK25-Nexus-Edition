...
public enum ShoutEventType {
	...
	IDLE, ATTACKED, // NPC was being attacked (the same as aggro)
	...
	CASTING, CAST_K, // Numeric cast shouts
	DIED, // Npc died
	HELP, // Calls help without running away
	HELPCALL, // Calls help and runs away
	WALK_WAYPOINT, // Reached the walk point
	START, WAKEUP, SLEEP, RESET_HATE, UNK_ACC, // Not clear but seems the same as ATTACKED
	...
	GOD_HELP, LEAVE, // when player leaves an attack
	BEFORE_DESPAWN, // NPC despawns
	ATTACK_DEADLY, WIN, ENEMY_DIED; // NPC's enemy died
