...
public enum PlayerClass {
	...
	TEMPLAR(2), // knight
	SCOUT(3, true), ASSASSIN(4), RANGER(5), MAGE(6, true), SORCERER(7), // wizard
	SPIRIT_MASTER(8), // elementalist
	PRIEST(9, true), CLERIC(10), CHANTER(11), ALL(12);

	/** This id is used on client side */
	private byte classId;

	/**
	 * This is the mask for this class id, used with bitwise AND in arguments that
	 * contain more than one possible class
	 */
	private int idMask;
	 ...
	 * @return PlayerClass objects that matches the given classId. If there isn't
	...
	/**
	 * @return true if this is one of starting classes ( player can create char with
	 *         this class )
	 */
