...
public enum ItemSlot {
	MAIN_HAND(1), SUB_HAND(1 << 1), HELMET(1 << 2), TORSO(1 << 3), GLOVES(1 << 4), BOOTS(1 << 5), EARRINGS_LEFT(1 << 6),
	EARRINGS_RIGHT(1 << 7), RING_LEFT(1 << 8), RING_RIGHT(1 << 9), NECKLACE(1 << 10), SHOULDER(1 << 11), PANTS(1 << 12),
	...
	// STIGMA slots
	STIGMA1(1 << 19), STIGMA2(1 << 20), STIGMA3(1 << 21), STIGMA4(1 << 22), STIGMA5(1 << 23), STIGMA6(1 << 24),
	...
	ADV_STIGMA1(1 << 26), ADV_STIGMA2(1 << 27), ADV_STIGMA3(1 << 28), ADV_STIGMA4(1 << 29), ADV_STIGMA5(1 << 30),
	...
	static {
		itemSlots = new TIntObjectHashMap<>();
