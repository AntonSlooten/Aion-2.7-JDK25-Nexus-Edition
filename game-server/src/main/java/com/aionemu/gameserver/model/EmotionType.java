...
public enum EmotionType {
	...
	LAND_FLYTELEPORT(7), WINDSTREAM(8), WINDSTREAM_END(9), WINDSTREAM_EXIT(10), WINDSTREAM_BOOST(11),
	WINDSTREAM_END_BOOST(12), FLY(13), LAND(14), RIDE(15), RIDE_END(16), DIE(18), RESURRECT(19), EMOTE(21),
	...
	START_LOOT(40), END_LOOT(41), START_QUESTLOOT(42), END_QUESTLOOT(43), START_FEEDING(50), END_FEEDING(51), NEW(52);
