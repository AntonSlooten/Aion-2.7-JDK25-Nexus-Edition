...
public class CQFDListenerManager {
	...
	private final static HashMap<CQFDListener, ScheduledFuture<?>> _timers = new HashMap<>();
	static {
		_classes = new HashMap<>();
		_classes.put(CQFDListenerType.PLAYER_KILL_PLAYER, new ArrayList<>());
		_classes.put(CQFDListenerType.PLAYER_KILL_MONSTER, new ArrayList<>());
		_classes.put(CQFDListenerType.MONSTER_KILL_PLAYER, new ArrayList<>());
		_classes.put(CQFDListenerType.MONSTER_KILL_MONSTER, new ArrayList<>());
		_classes.put(CQFDListenerType.PLAYERDEATH, new ArrayList<>());
		_classes.put(CQFDListenerType.MONSTERDEATH, new ArrayList<>());
	}
