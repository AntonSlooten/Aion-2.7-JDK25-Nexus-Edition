		...
		if (target == null || target.equals(admin)) {
			PacketSendUtility.sendMessage(admin,
					"[Info about you]" + "\nPlayer Id: " + admin.getObjectId() + "\nMap ID: " + admin.getWorldId()
							+ "\nX: " + admin.getCommonData().getPosition().getX() + " / Y: "
							+ admin.getCommonData().getPosition().getY() + " / Z: "
							+ admin.getCommonData().getPosition().getZ() + " / Heading: "
							+ admin.getCommonData().getPosition().getHeading());
			...
			PacketSendUtility.sendMessage(admin,
					"[Info about " + player.getName() + "]" + "\nPlayer Id: " + player.getObjectId() + "\nAccount: "
							...
							+ "\nX: " + player.getCommonData().getPosition().getX() + " / Y: "
							+ player.getCommonData().getPosition().getY() + " / Z: "
							+ player.getCommonData().getPosition().getZ() + " / Heading: "
			...
			PacketSendUtility.sendMessage(admin, "[Stats]" + "\nPvP attack: "
					...
					+ "\n----------Main Hand------------\nAttack: "
					+ player.getGameStats().getMainHandPAttack().getCurrent() + "\nAccuracy: "
					+ player.getGameStats().getMainHandPAccuracy().getCurrent() + "\nCritical: "
					+ player.getGameStats().getMainHandPCritical().getCurrent()
					+ "\n------------Off Hand------------\nAttack: "
					+ player.getGameStats().getOffHandPAttack().getCurrent() + "\nAccuracy: "
					+ player.getGameStats().getOffHandPAccuracy().getCurrent() + "\nCritical: "
					+ player.getGameStats().getOffHandPCritical().getCurrent()
					+ "\n-------------Main Hand Magical-------------\nAttack: "
					+ player.getGameStats().getMAttack().getCurrent() + "\nAccuracy: "
			...
			PacketSendUtility.sendMessage(admin,
					"[Info about target]" + "\nName: " + npc.getName() + "\nId: " + npc.getNpcId() + " / ObjectId: "
							...
							+ " / Y: " + admin.getTarget().getY() + " / Z: " + admin.getTarget().getZ() + " / Heading: "
			...
			if (npc.getSpawn().getWalkerId() != null) {
				...
				if (template != null) {
					...
					if (npc.getWalkerGroup() != null) {
						...
						PacketSendUtility.sendMessage(admin,
								"[Group]" + "\nType: " + npc.getWalkerGroup().getWalkType() + " / XDelta: "
										+ snpc.getXDelta() + " / YDelta: " + snpc.getYDelta() + " / Index: "
										+ snpc.getWalkerIndex());
					}
				}
			}
			...
			PacketSendUtility.sendMessage(admin,
					"[Info about gather]\n" + "Name: " + gather.getName() + "\nId: "
							+ gather.getObjectTemplate().getTemplateId() + " / ObjectId: "
							+ admin.getTarget().getObjectId() + "\nMap ID: " + admin.getTarget().getWorldId() + "\nX: "
							+ admin.getTarget().getX() + " / Y: " + admin.getTarget().getY() + " / Z: "
