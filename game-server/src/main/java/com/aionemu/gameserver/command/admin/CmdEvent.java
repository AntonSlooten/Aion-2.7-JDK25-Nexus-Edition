...
public class CmdEvent extends BaseCommand {
	...
	public void execute(Player player, String... params) {
		if (params.length == 0) {
			HTMLService.showHTML(player,
					getHtmlSummary("============= Team ============   <br>" + "addTeam \"teamId\"              <br>"
							+ "rmTeam \"teamId\"               <br>" + "clearTeam                         <br>"
							+ "disableSoulSick                   <br>" + "enableSoulSick                    <br>"
							+ "============= Player ============ <br>" + "addPlayer \"playerName\" !\"teamId\"  <br>"
							+ "rmPlayer \"playerName\"             <br>" + "setTeam \"playerName\" \"teamId\"     <br>"
							+ "res   !\"t\"     !\"teamId\" <br>" + "respawn !\"teamId\" <br>"
							+ "============= Teleport ========== <br>" + "teleportPlayer \"PlayerName\"       <br>"
							+ "teleportTeam !\"teamId\"            <br>" + "start                       <br>"
							+ "kick \"playerName\"   <br>" + "teleportBackTeam !\"teamId\"        <br>"
							+ "stop                   <br>" + "============== Reward =========== <br>"
							+ "addReward \"itemId\" \"itemCount\" !\"rewardId\" <br>;"
							+ "clearReward !\"rewardId\"           <br>"
							+ "rewardPlayer \"playerName\" !\"rewardId\" <br>"
							+ "rewardTeam   \"teamId\"     !\"rewardId\" <br>" + "rewardAll !\"rewardId\"" + "stat"));
			return;
		}
		try {
	...
	public String getHtmlSummary(String content) {
		...
		String html = "<poll>" + "<poll_introduction>" + "	<![CDATA[<font color='4CB1E5'>" + title + "</font>]]>"
				+ "</poll_introduction>" + "<poll_title>" + "	<font color='ffc519'></font>" + "</poll_title>"
				+ "<questions>" + "	<question>" + "		<title>" + "			<![CDATA[";

		html += content;
		html += "		]]>" + "			</title>" + "			<select>"
				+ "				<input type='radio'>Close the window</input>" + "			</select>"
