	...
	public void execute(Player player, String... params) {
		...
		if (category == ItemCategory.FLUX || category == ItemCategory.GATHERABLE || category == ItemCategory.RAWHIDE
			...
			if (count == 0) {
				...
				String message = TranslationService.GIVE_ME_SUCCESS.toString(player, String.valueOf(itemCount),
			...
			// This item cannot be given with this command. Check if you can buy it or craft
			// it
