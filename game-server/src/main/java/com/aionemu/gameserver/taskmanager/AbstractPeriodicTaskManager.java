...
public abstract class AbstractPeriodicTaskManager extends AbstractLockManager implements Runnable, StartupHook {
	...
	protected AbstractPeriodicTaskManager(final int period) {
		this.period = period;
	...
	/**
	 * Must be called by subclasses after construction is complete.
	 */
	protected final void registerStartupHook() {
