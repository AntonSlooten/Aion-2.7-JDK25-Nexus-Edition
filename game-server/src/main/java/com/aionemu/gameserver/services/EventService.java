...
public class EventService {
	...
	private static final int CHECK_TIME_PERIOD = 1000 * 60 * 5;
	...
	private volatile boolean isChristmas;

	private final TIntObjectHashMap<List<EventTemplate>> eventsForStartQuest = new TIntObjectHashMap<>();

	private final TIntObjectHashMap<List<EventTemplate>> eventsForMaintainQuest = new TIntObjectHashMap<>();
	...
	private EventService() {
		activeEvents = new ArrayList<>(DataManager.EVENT_DATA.getActiveEvents());
		updateQuestMap();
	}
	...
	public void start() {
		...
		checkTask = ThreadPoolManager.getInstance().scheduleAtFixedRate(this::checkEvents, 0, CHECK_TIME_PERIOD);
	}
