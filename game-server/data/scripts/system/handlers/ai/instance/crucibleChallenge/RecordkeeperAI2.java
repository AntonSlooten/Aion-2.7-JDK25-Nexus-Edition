	...
	public boolean onDialogSelect(Player player, int dialogId, int questId) {
		...
		if (dialogId == 10000) {
			...
			case 205674: // move to stage 2
				TeleportService.teleportTo(player, 300320000, instanceId, 1796.5513f, 306.9967f, 469.25f, (byte) 60, 0,
						false);
			...
			case 205675: // move to stage 3
				TeleportService.teleportTo(player, 300320000, instanceId, 1324.433f, 1738.2279f, 316.476f, (byte) 70, 0,
						false);
			...
			case 205676: // movet to stage 4
				switch (Rnd.get(1, 2)) {
				case 1:
					TeleportService.teleportTo(player, 300320000, instanceId, 1283.1246f, 791.6683f, 436.6403f,
							(byte) 60, 0, false);
					spawn(205685, 1308.9664f, 796.20276f, 437.29678f, (byte) 60);
					spawn(205671, 1271.4222f, 791.36145f, 436.64017f, (byte) 0);
					break;
				case 2:
					TeleportService.teleportTo(player, 300320000, instanceId, 1270.8877f, 237.93307f, 405.38028f,
							(byte) 60, 0, false);
