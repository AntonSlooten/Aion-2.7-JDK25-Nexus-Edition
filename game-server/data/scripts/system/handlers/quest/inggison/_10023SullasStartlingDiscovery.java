				...
				case STEP_TO_13: {
					if (var == 12) {
						if (player.getInventory().getItemCountByItemId(182206613) > 0) {
							...
							TeleportService.teleportTo(player, 300160000, newInstance.getInstanceId(), 744.761f,
									940.3738f, 149.28333f, (byte) 91, 3000, true);
							return true;
						} else
	...
	public boolean onKillEvent(final QuestEnv env) {
		...
		case 216531:
			if (qs.getQuestVarById(0) == 14 || qs.getQuestVarById(0) == 15) {
				QuestService.addNewSpawn(300160000, instanceId, 730229, npc.getX(), npc.getY(), npc.getZ(),
						npc.getHeading());
