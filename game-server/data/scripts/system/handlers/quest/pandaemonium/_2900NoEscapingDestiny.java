			...
			case 203546: { // Skuld
				...
				case STEP_TO_5: {
					if (var == 4) {
						...
						TeleportService.teleportTo(player, 320070000, newInstance.getInstanceId(), 268.47397f,
								251.80275f, 125.8369f, 3000, true);
			...
			case 204264: { // Skuld 2
				...
				case STEP_TO_8: {
					if (var == 97) {
						...
						QuestService.addNewSpawn(320070000, player.getInstanceId(), 204263, 257.5f, 245f, 129f,
								(byte) 0);
						return closeDialogWindow(env);
					}
				}
