	...
	public boolean onAttackEvent(QuestEnv env) {
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			if (var == 2) {
				...
				final SpawnSearchResult searchResult = DataManager.SPAWNS_DATA2.getFirstSpawnByNpcId(npc.getWorldId(),
						278086); // Sinjah
				if (MathUtil.getDistance(searchResult.getSpot().getX(), searchResult.getSpot().getY(),
						searchResult.getSpot().getZ(), npc.getX(), npc.getY(), npc.getZ()) <= 20) {
