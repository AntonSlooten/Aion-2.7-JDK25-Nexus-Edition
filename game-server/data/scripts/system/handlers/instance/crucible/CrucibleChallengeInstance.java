				...
				public void run() {
					...
					if (player != null) {
						QuestState qs = player.getQuestStateList()
								.getQuestState(player.getRace() == Race.ASMODIANS ? 28208 : 18208);
						if (qs != null && qs.getStatus() == QuestStatus.START) {
							if (qs.getQuestVarById(0) == 1 || qs.getQuestVarById(1) == 4) { // 5 x Vanktrist Spacetwine
																							// killed
	...
	private void startBonusStage2() {
		...
		ThreadPoolManager.getInstance().schedule(new Runnable() {
			...
			public void run() {
				...
				SpawnTemplate template = SpawnEngine.addNewSingleTimeSpawn(mapId, 217802, 1780.5665f, 307.40463f,
						469.25f, (byte) 0);
