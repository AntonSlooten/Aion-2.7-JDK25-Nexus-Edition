...
public class GameChannelHandler extends AbstractChannelHandler {
	...
	public void messageReceived(ChannelHandlerContext ctx, MessageEvent e) throws Exception {
		...
		/**
		 * Packet is frame decoded and decrypted at this stage Here packet will be read
		 * and submitted to execution
		 */
		AbstractGameClientPacket gameServerPacket = GameServerPacketHandler.handle((ChannelBuffer) e.getMessage(),
				this);
